...
export function TrophyIcon({ className, size = 24 }: IconProps) {
  return (
    <svg width={size} height={size} viewBox="0 0 24 24" fill="none" className={className}>
      ...
      <path
        d="M7 4h10v6c0 2.761-2.239 5-5 5s-5-2.239-5-5V4z"
        fill="currentColor"
        fillOpacity="0.2"
        stroke="currentColor"
        strokeWidth="2"
      />
      <path
        d="M7 6H4c0 2.5 1.5 4 3 4"
        stroke="currentColor"
        strokeWidth="2"
        strokeLinecap="round"
      />
      <path
        d="M17 6h3c0 2.5-1.5 4-3 4"
        stroke="currentColor"
        strokeWidth="2"
        strokeLinecap="round"
      />
...
export function UsersIcon({ className, size = 24 }: IconProps) {
  return (
    <svg width={size} height={size} viewBox="0 0 24 24" fill="none" className={className}>
      ...
      />
      <path
        d="M3 21v-2c0-2.21 2.686-4 6-4s6 1.79 6 4v2"
        stroke="currentColor"
        strokeWidth="2"
        strokeLinecap="round"
      />
...
export function AnimatedIconWrapper({ children, className, color = 'primary' }: AnimatedIconProps) {
  ...
  return (
    <motion.div
      ...
      className={cn('flex items-center justify-center rounded-2xl', colorClasses[color], className)}
    >
      {children}
    </motion.div>
  );
